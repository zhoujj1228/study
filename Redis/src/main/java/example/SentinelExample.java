...
public class SentinelExample {
	public static void main(String[] args) throws IOException {
		...
		sentinelAddressList.add("192.168.111.200:26379");
		sentinelAddressList.add("192.168.111.200:26380");
		sentinelAddressList.add("192.168.111.200:26381");
		...
		resource.set("test", "testSentinelValue");
		resource.close();
